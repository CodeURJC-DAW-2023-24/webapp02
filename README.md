...
- Juan Álvarez Loeches:
    ...
    - 5 Commits más destacados:
      ...
      - 2: Function Add New List Added (with fixed stats): https://github.com/CodeURJC-DAW-2023-24/webapp02/commit/8f318748cedb50211fe29cee7e1bf0cc78e62d3f
...
- Aurora María Fernández Basanta:
    - Descripción: Creación de los componentes necesarios para la pantalla principal/main | Creación de componentes necesarios para la pantalla SingleElement |  Creación del componente de las cards y su muestra en escena usado tanto en main como en profile | Ayuda en la integración del banner de la pantalla perfil |  Modificación de la api de usuarios para su añadido de imagenes de perfil + modificación de algunas funciones de actualización del User | Creación de la api de reviews + su .service y model | Creación de la función para añadir y editar reviews en SingleElement y creación tambien de su función para añadir el elemento a la lista del usuario deseada | Instalación de Bootstrap en el proyecto.
    - 5 Commits más destacados:
