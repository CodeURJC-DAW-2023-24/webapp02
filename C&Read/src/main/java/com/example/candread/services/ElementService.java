...
public class ElementService {
    ...
    public void startAPi() throws Exception {
        String token = AnimeApiService.obtenerTokenAcceso("17613", "7QrmBNlyp9dtKpbE2LXZ7t8bExuWcsoVNlTyRXhS");
        //String animeInfo = obtenerInfoAnime(token, 15125);
        //System.out.println(animeInfo);
        // Procesar la información obtenida

    }

    private String obtenerInfoAnime(String token, int idAnime) throws Exception {
        ...
        variables.put("id", idAnime);

        // Define la URL de la API de AniList GraphQL
        String url = "https://graphql.anilist.co";

        // Construye el cuerpo de la solicitud GraphQL
        ...
        if (response.statusCode() == 200) {
            ...
            throw new RuntimeException("Error en la solicitud GraphQL: " + response.body());
        }
    }
