...
public class ElementService {
    ...
    public void insertElement() throws IOException, SerialException, SQLException{
        ...
        elementoTest4.setImageFile(blobi);
        ...
        elementoTest5.setImageFile(blobi);
        ...
        elementoTest6.setImageFile(blobi);
        ...
        elementoTest7.setImageFile(blobi);
        ...
        elementoTest8.setImageFile(blobi);
        ...
        States.EN_EMISION.name(), Countries.JAPON.name(), generosEjemplo1);
        elementoTest10.setImageFile(blobi);
