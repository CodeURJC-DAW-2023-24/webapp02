...
public class ElementService {
    ...
    public void insertSeries () throws SerialException, IOException, SQLException {
        ...
        "La historia tiene lugar 30 años antes de los acontecimientos de Magi. En esta era nos centraremos en el viaje que tiene que realizar Sinbad para convertirse en rey.",        "Arthur Conan Doyle", 
        ...
        States.EN_EMISION.name(), Countries.ESPAÑA.name(), generosEjemplo1);
