...
public class ElementService {
    ...
    public void insertElement(){
        ...
        Countries.ESTADOS_UNIDOS.name(), generosEjemplo1, reviewsEjemplo);
        ...
        States.EN_EMISION.name(), Countries.JAPON.name(), generosEjemplo1, reviewsEjemplo);
        ...
        "Carlos Luis Zafon", "Marina.jpg", Types.LIBRO.name(), Seasons.INVIERNO.name(), 
        States.COMPLETO.name(), Countries.ESPAÑA.name(), generosEjemplo1, reviewsEjemplo);
        ...
        "Brandon Sanderson", "El_Imperio_Final.jpg", Types.LIBRO.name(), Seasons.VERANO.name(), 
        States.COMPLETO.name(), Countries.ESTADOS_UNIDOS.name(), generosEjemplo1, reviewsEjemplo);
        ...
        "Chugong", "Solo Leveling.jpg", Types.LIBRO.name(), Seasons.PRIMAVERA.name(), 
        States.COMPLETO.name(), Countries.COREA.name(), generosEjemplo1,reviewsEjemplo);
        ...
        "Arthur Conan Doyle", "Signo_Cuatro.jpg", Types.LIBRO.name(), Seasons.INVIERNO.name(), 
        States.COMPLETO.name(), Countries.REINO_UNIDO.name(), generosEjemplo1, reviewsEjemplo);
        ...
        "Cixin Liu", "Problema_Tres_Cuerpos.jpg", Types.LIBRO.name(), Seasons.INVIERNO.name(), 
        States.COMPLETO.name(), Countries.CHINA.name(), generosEjemplo1,reviewsEjemplo);
        ...
        "J.K. Rowling", "HP_Piedra_Filosofal.jpg", Types.LIBRO.name(), Seasons.VERANO.name(), 
        States.COMPLETO.name(), Countries.REINO_UNIDO.name(), generosEjemplo1, reviewsEjemplo);
        ...
        "Gege Akutami", "Jujutsu_Kaisen1.jpg", Types.LIBRO.name(), Seasons.PRIMAVERA.name(), 
        States.EN_EMISION.name(), Countries.JAPON.name(), generosEjemplo1, reviewsEjemplo);
